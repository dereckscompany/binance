...
- **Position Management**: View positions, set leverage, margin type,
  and position mode.

- **Account Queries**: Retrieve account info, balances, trades, and
  income history.
...
- `"TAKE_PROFIT"`, `"TAKE_PROFIT_MARKET"`: conditional take-profit
  orders.
...
- [`BinanceFutures$add_order_test()`](#method-BinanceFutures-add_order_test)

- [`BinanceFutures$cancel_order()`](#method-BinanceFutures-cancel_order)

- [`BinanceFutures$cancel_all_orders()`](#method-BinanceFutures-cancel_all_orders)

- [`BinanceFutures$get_order()`](#method-BinanceFutures-get_order)

- [`BinanceFutures$get_open_orders()`](#method-BinanceFutures-get_open_orders)

- [`BinanceFutures$get_all_orders()`](#method-BinanceFutures-get_all_orders)

- [`BinanceFutures$get_account()`](#method-BinanceFutures-get_account)

- [`BinanceFutures$get_balances()`](#method-BinanceFutures-get_balances)

- [`BinanceFutures$get_positions()`](#method-BinanceFutures-get_positions)

- [`BinanceFutures$set_leverage()`](#method-BinanceFutures-set_leverage)

- [`BinanceFutures$set_margin_type()`](#method-BinanceFutures-set_margin_type)

- [`BinanceFutures$modify_position_margin()`](#method-BinanceFutures-modify_position_margin)

- [`BinanceFutures$get_position_margin_history()`](#method-BinanceFutures-get_position_margin_history)

- [`BinanceFutures$get_trades()`](#method-BinanceFutures-get_trades)

- [`BinanceFutures$get_income_history()`](#method-BinanceFutures-get_income_history)

- [`BinanceFutures$set_position_mode()`](#method-BinanceFutures-set_position_mode)

- [`BinanceFutures$get_position_mode()`](#method-BinanceFutures-get_position_mode)

- [`BinanceFutures$clone()`](#method-BinanceFutures-clone)
...
Overrides the base constructor to use the futures base URL and the
futures-specific server time endpoint (`/fapi/v1/time`).
...
Simulates placing a futures order without execution. Validates all
parameters and authentication exactly as `add_order()`, but no order is
actually created.
...
Retrieves details for a specific futures order by order ID or client
order ID.
...
Retrieves all currently open futures orders, optionally filtered by
symbol.
...
- `incomeType`:
  ...
  `"INTERNAL_TRANSFER"`, `"AUTO_EXCHANGE"`, `"DELIVERED_SETTELMENT"`,
