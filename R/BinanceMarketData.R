...
BinanceMarketData <- R6::R6Class(
  ...
  public = list(
    ...
    #'   - price_min (numeric | NA) Minimum price from PRICE_FILTER (`NA` when the
    #'     symbol carries no PRICE_FILTER).
    #'   - price_max (numeric | NA) Maximum price from PRICE_FILTER (`NA` when the
    #'     symbol carries no PRICE_FILTER).
    ...
    get_klines = function(
      ...
      assert_args_BinanceMarketData__get_klines(
        symbol,
        interval,
        start_time,
        end_time,
